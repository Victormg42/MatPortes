...
<body class="legal">
    ...
    <div class="politica_cookies">
        ...
        <h2 style="text-align:center;">Entidad Responsable</h2>
            <p>La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página , propiedad de Mariano – .</p>
        ...
        <h2 style="text-align:center;">¿Qué tipos de cookies existen?</h2>
        ...
        <h2 style="text-align:center;">Cookies de geo-localización</h2>
        ...
        <h2 style="text-align:center;">Cookies de registro</h2>
        ...
        <h2 style="text-align:center;">Cookies de analíticas</h2>
        <p>Cada vez que un usuario visita un servicio, una herramienta de un proveedor externo genera una cookie analítica en el ordenador del usuario. Esta cookie que sólo se genera en la visita, servirá en próximas visitas a los servicios de Mariano para identificar de forma anónima al visitante. Los objetivos principales que se persiguen son:</p>
        ...
        <p>Identificar de forma anónima los contenidos más visitados y por lo tanto más atractivos para los usuarios Saber si el usuario que está accediendo es nuevo o repite visita.</p>

        <p>Importante: Salvo que el usuario decida registrarse en un servicio de Mariano, la cookie nunca irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la experiencia de los usuarios en el sitio.</p>

        <h2 style="text-align:center;">Cookies de publicidad</h2>
        <p>Este tipo de cookies permiten ampliar la información de los anuncios mostrados a cada usuario anónimo en los servicios de Mariano. Entre otros, se almacena la duración o frecuencia de visualización de posiciones publicitarias, la interacción con las mismas, o los patrones de navegación y/o comportamientos del usuario ya que ayudan a conformar un perfil de interés publicitario. De este modo, permiten ofrecer publicidad afín a los intereses del usuario.</p>

        <h2 style="text-align:center;">Cookies publicitarias de terceros</h2>
        <p>Además de la publicidad gestionada por las webs de Mariano en sus servicios, las webs de Mariano ofrecen a sus anunciantes la opción de servir anuncios a través de terceros (“Ad-Servers”). De este modo, estos terceros pueden almacenar cookies enviadas desde los servicios de Mariano procedentes de los navegadores de los usuarios, así como acceder a los datos que en ellas se guardan.</p>

        <p>Las empresas que generan estas cookies tienen sus propias políticas de privacidad. En la actualidad, las webs de Mariano utilizan la plataforma Doubleclick (Google) para gestionar estos servicios. Para más información, acuda a</p>

        <p>
            <div class="overflow">
                <a href="http://www.google.es/policies/privacy/ads/#toc-doubleclick">
                http://www.google.es/policies/privacy/ads/#toc-doubleclick</a> 
            </div>
            y a 
            <div class="overflow">
        ...
        <h2 style="text-align:center;">¿Cómo puedo deshabilitar las cookies en mi navegador?</h2>
        ...
        <p>Para más información sobre la administración de las cookies en Google Chrome: </p>
            <div class="overflow">
                <a href="https://support.google.com/chrome/answer/95647?hl=es">https://support.google.com/chrome/answer/95647?hl=es</a>
            </div>

        <p>Para más información sobre la administración de las cookies en Internet Explorer:</p>
        <div class="overflow">
        ...
        <p>Para más información sobre la administración de las cookies en Mozilla Firefox:</p>
        <div class="overflow">
        <a href="http://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-que-los-sitios-we">http://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-que-los-sitios-we</a>
        </div>

        <p>Para más información sobre la administración de las cookies en Safari: 
        </p>
        <div class="overflow">
            <a href="http://www.apple.com/es/privacy/use-of-cookies/">http://www.apple.com/es/privacy/use-of-cookies/</a>
        </div>

        <p>Para más información sobre la administración de las cookies en Opera:</p>
        <div class="overflow">
            <a href="http://help.opera.com/Windows/11.50/es-ES/cookies.html">http://help.opera.com/Windows/11.50/es-ES/cookies.html</a>
        </div>

        <p>Si desea dejar de ser seguido por Google Analytics visite:</p>
        <div class="overflow">
            <a href="http://tools.google.com/dlpage/gaoptout">http://tools.google.com/dlpage/gaoptout</a>
        </div>

        <h2 style="text-align:center;">Para saber más sobre las cookies</h2>
        <p>Puede obtener más información sobre la publicidad online basada en el comportamiento y la privacidad online en el siguiente enlace:</p>
        <div class="overflow">
            <a href="http://www.youronlinechoices.com/es/">http://www.youronlinechoices.com/es/</a>
        </div>

        <p>Protección de datos de Google Analytics:</p>
        <div class="overflow">
            <a href="http://www.google.com/analytics/learn/privacy.html">http://www.google.com/analytics/learn/privacy.html</a>
        </div>

        <p>Cómo usa Google Analytics las cookies:</p>
        <div class="overflow">
        ...
        <h2 style="text-align:center;">Actualizaciones y cambios en la política de privacidad/cookies</h2>
        <p>Las webs de Mariano pueden modificar esta Política de Cookies en función de exigencias legislativas, reglamentarias, o con la finalidad de adaptar dicha política a las instrucciones dictadas por la Agencia Española de Protección de Datos, por ello se aconseja a los usuarios que la visiten periódicamente.</p>
