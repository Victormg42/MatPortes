...
<body class="legal">
    ...
    <div class="avisolegal">
        <h1 style="text-align:center;">Aviso legal y términos de uso</h1>
            ...
            <h2 style="text-align:center;">Condiciones generales de uso</h2>
            ...
            <h2 style="text-align:center;">Datos personales que recabamos y cómo lo hacemos</h2>
                <p>Leer Política de Privacidad</p>

            <h2 style="text-align:center;">Compromisos y obligaciones de los usuarios</h2>
            ...
            <h2 style="text-align:center;">Reclamaciones</h2>
            ...
            <h2 style="text-align:center;">Derechos de propiedad intelectual e industrial</h2>
                <p>En virtud de lo dispuesto en los artículos 8 y 32.1, párrafo segundo, de la Ley de Propiedad Intelectual, quedan expresamente prohibidas la reproducción, la distribución y la comunicación pública, incluida su modalidad de puesta a disposición, de la totalidad o parte de los contenidos de esta página web, con fines comerciales, en cualquier soporte y por cualquier medio técnico, sin la autorización de . El usuario se compromete a respetar los derechos de Propiedad Intelectual e Industrial titularidad de .
                El usuario conoce y acepta que la totalidad del sitio web, conteniendo sin carácter exhaustivo el texto, software, contenidos (incluyendo estructura, selección, ordenación y presentación de los mismos) podcast, fotografías, material audiovisual y gráficos, está protegida por marcas, derechos de autor y otros derechos legítimos, de acuerdo con los tratados internacionales en los que España es parte y otros derechos de propiedad y leyes de España. En el caso de que un usuario o un tercero consideren que se ha producido una violación de sus legítimos derechos de propiedad intelectual por la introducción de un determinado contenido en la web, deberá notificar dicha circunstancia a indicando:
            ...
            <h2 style="text-align:center;">Política de comentarios</h2>
            ...
            <h2 style="text-align:center;">Exclusión de garantía y responsabilidad</h2>
                ...
                <p>uso ilícito, negligente, fraudulento o contrario a este Aviso Legal;</p>
            ...
            <h2 style="text-align:center;">Ley aplicable y jurisdicción</h2>
                <p>Con carácter general las relaciones entre con los Usuarios de sus servicios telemáticos, presentes en esta web se encuentran sometidas a la legislación y jurisdicción españolas y a los tribunales.</p>

            <h2 style="text-align:center;">Contacto</h2>
                <p>En caso de que cualquier Usuario tuviese alguna duda acerca de estas Condiciones legales o cualquier comentario sobre el portal , por favor diríjase a</p>
